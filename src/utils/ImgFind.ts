...
function findAllImages(
  ...
  //   }
  // }
  let Image=data?.children?.blipFill?.properties?.image?.link
  let Media=data?.properties?.videoFile?.link
  let Coordinates=data?.shape?.xfrm?.off?.value
  console.log(Image,Media,Coordinates);
}
