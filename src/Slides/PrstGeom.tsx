            ...
            if (prst) {
                if (prst === 'roundRect') {
                    ...
                    const color = extractSolidFillColor(
                        node._properties.ln.solidFill,
                    );
                    const lineWidth = emuToPx(
                        node._properties.ln.w,
                        maxDim.width,
                        0,
                    );
                    ...
                    const dash = extractDash(
                        node[NodeAttribs.PROPERTIES].ln?.prstDash,
                    );
                    ...
                    if (paths) {
                        if (paths.headEnd && paths.headEnd.type !== 'none')
                            head = true;
                        if (paths.tailEnd && paths.tailEnd.type !== 'none')
                            tail = true;
                    }
